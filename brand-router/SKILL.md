...
- The twelve surfaces every direction answers: [`../_lib/surfaces.md`](../brand-router/_lib/surfaces.md)
- Shared non-negotiables: [`../_lib/craft-floor.md`](../brand-router/_lib/craft-floor.md)

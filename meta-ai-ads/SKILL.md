...
`../meta-ads/SKILL.md`. Meta’s first-party Google Tag Manager template shows
...
`../meta-ads/SKILL.md`. Do not copy that mapping into this skill and label it
Meta AI behavior.
...
approved Meta inventory, through `../meta-ads/SKILL.md`. Do not send a hub
...
and [the Meta Ads skill](../meta-ads/SKILL.md).
...
`../meta-ads/SKILL.md`. See [Meta’s Pixel template](https://github.com/facebook/GoogleTagManager-WebTemplate-For-FacebookPixel/blob/main/template.tpl).

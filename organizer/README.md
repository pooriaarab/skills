...
| [`notion-organizer`](notion/SKILL.md) | Notion (MCP) | "organize my Notion", "clean up workspace" |
| [`google-drive-organizer`](google-drive/SKILL.md) | Google Drive (gws / Drive API) | "organize my Drive" |
| [`mac-organizer`](mac/SKILL.md) | local macOS (Downloads / Desktop / Documents / caches) | "free up disk", "clean my Mac" |
...
| [`org-google-contacts`](../org-google-contacts/SKILL.md) | Google Contacts (People API) | "dedupe gmail contacts", "contact groups in google" |

...
```
1. Scope — which accounts? (iCloud / <employer> / Personal Gmail / On My Mac)
...
- [`../notion-organizer/SKILL.md`](../notion-organizer/SKILL.md) — for CRM-style structured data, prefer Notion over Notes

...
iCloud Lists ≈ Google groups. Both surfaces support add-only categorization. Propose a small scheme aligned with the user's knowledge graph (avoid inventing a parallel taxonomy — see `../org-life-organizer/_lib/taxonomy.md`).

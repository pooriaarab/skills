...
The recipe was forged building Solo Payments (see [<private-design-repo>](https://github.com/<private-design-repo>) `html-clone/` for the worked example). This skill generalizes it across codebases.

---
name: samsung-ads
description: "Set up Samsung Ads tracking as a regional or CTV adapter — official token or partner access, client tag or app measurement, server conversion shape, audience limits, reporting verification, and explicit unverified boundaries. Use when evaluating Samsung Ads, planning a regional campaign, or deciding whether a production integration exists."
---
...
Samsung documents TIFA, limit-ad-tracking controls, and aggregated Samsung Ads attribution for Smart TV. Advertiser CAPI details remain account gated.

Official source: [Samsung Ads documentation](https://developer.samsung.com/smarttv/develop/api-references/samsung-product-api-references/adinfo-api.html).
...
Samsung Smart TV apps can read TIFA and the limit-ad-tracking state with the official AdInfo API. This is app/device context, not a website pixel. [Official AdInfo API](https://developer.samsung.com/smarttv/develop/api-references/samsung-product-api-references/adinfo-api.html).
...
source: [Samsung Ads](https://developer.samsung.com/smarttv/develop/api-references/samsung-product-api-references/adinfo-api.html).
...
1. Open the official Samsung Ads developer or advertiser site: [Samsung Ads](https://developer.samsung.com/smarttv/develop/api-references/samsung-product-api-references/adinfo-api.html).
...
4. Store the approved credential as `SAMSUNG_ADS_TOKEN`. Keep it server-side.
...
```bash
curl -sS 'https://developer.samsung.com/smarttv/develop/api-references/samsung-product-api-references/adinfo-api.html' -H "Authorization: Bearer $SAMSUNG_ADS_TOKEN"
```
...
fields, minimum usable size, lookalike expansion, and eligibility at [Samsung Ads](https://developer.samsung.com/smarttv/develop/api-references/samsung-product-api-references/adinfo-api.html).
...
- Make `SAMSUNG_ADS_PIXEL_ID` and `SAMSUNG_ADS_TOKEN` absent-safe no-ops.
...
Load code only from the vendor's official HTTPS origin. Keep `SAMSUNG_ADS_TOKEN`
...
- https://developer.samsung.com/smarttv/develop/api-references/samsung-product-api-references/adinfo-api.html
